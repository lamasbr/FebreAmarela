...
FebreAmarela.GameStateInstrucoes = {
    init: function () {
    ...
    preload: function () {
        ...
        this.load.image('imgInstrucoes', 'assets/images/instrucoes.png');
    ...
    create: function () {
        ...
        this.imgInstrucoes = this.add.sprite(this.game.world.centerX, this.game.world.centerY - 30, 'imgInstrucoes');
        this.imgInstrucoes.anchor.setTo(0.5);
    ...
    listener: function(){
        game.state.start('GameStateFloresta');
    }
};