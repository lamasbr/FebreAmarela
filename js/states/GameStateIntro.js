...
FebreAmarela.GameStateIntro = {
    ...
    preload: function () {
        ...
        this.load.image('logoGame', 'assets/images/logoGame.png');
    ...
    create: function () {
        ...
        this.logoGame = this.add.sprite(this.game.world.centerX, this.game.world.centerY - 100, 'logoGame');
        this.logoGame.anchor.setTo(0.5);
