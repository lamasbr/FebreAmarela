...
FebreAmarela.GameStateFloresta = {
    ...
    preload: function () {
        ...
        this.load.image('platform', 'assets/images/plataformas/grama/gramaGrande.png');
        ...
        this.load.image('particulaInimigo', 'assets/images/inimigos/particulaInimigo.png');
        ...
        this.load.text('floresta', 'assets/data/floresta.json');
    },

    create: function () {
        this.levelData = JSON.parse(this.game.cache.getText('floresta'));
    ...
    win: function(){
        if(this.scoreMosquitos === 0 && this.scoreLixos === 0){
            game.state.start('GameStateCerrado');
        }
    },
