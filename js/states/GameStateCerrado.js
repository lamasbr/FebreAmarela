...
FebreAmarela.GameStateCerrado = {
    ...
    preload: function () {
        this.load.image('background', 'assets/images/backgrounds/cerrado.png');
        ...
        this.load.text('cerrado', 'assets/data/cerrado.json');
    },

    create: function () {
        this.levelData = JSON.parse(this.game.cache.getText('cerrado'));
    ...
    win: function(){
        if(this.scoreMosquitos === 0 && this.scoreLixos === 0){
            game.state.start('GameStateDeserto');
        }
    },
